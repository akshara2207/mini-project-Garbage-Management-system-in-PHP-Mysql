    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation" style='background-color:#37517e'>
        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse">
            <ul class="nav navbar-nav side-nav">
                <li>
                    <a href="#Dashboard" data-toggle="collapse" data-target="#submenu-1"><i class="fa fa-fw fa-search"></i><mark> Complaints</mark> <i class="fa fa-fw fa-angle-down pull-right"></i></a>
                   
                </li>
                <li>
                    <a href="add_locality.php"><i class="fa fa-fw fa-paper-plane-o"></i> Add locality</a>
                </li>
                <li>
                    <a href="bin_management.php"><i class="fa fa-fw fa-paper-plane-o"></i> Add bin</a>
                </li>
                <li>
                    <a href="update_bin.php"><i class="fa fa-fw fa-paper-plane-o"></i>Update bin</a>
                </li>
                <li>
                    <a href="add_driver.php"><i class="fa fa-fw fa-paper-plane-o"></i> Add driver</a>
                </li>
                <li>
                    <a href="driver_view.php"><i class="fa fa-fw fa-paper-plane-o"></i> View drivers</a>
                </li>
                <li>
                <li>
                    <a href="user_view.php"><i class="fa fa-fw fa-paper-plane-o"></i> View users</a>
                </li>
                <li>
                    <a href="work_assign.php"><i class="fa fa-fw fa-paper-plane-o"></i> Work Assign</a>
                </li>
                <li>
