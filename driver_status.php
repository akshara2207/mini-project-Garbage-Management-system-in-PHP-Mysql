  ...
  $Id= $_POST['id'];
   ...
   $query = "update garbageinfo set status= '$status' WHERE Id= '$Id' " ;
    ...
    if($data) {
       ...
       header("Location: http://localhost/wastems/driver_view_complaints.php", TRUE, 301);
       exit();
...
<body>
   ...
   <form method="post" action="driver_view_complaint.php"enctype="multipart/form-data">
